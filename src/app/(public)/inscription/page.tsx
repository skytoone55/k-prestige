...
export default function InscriptionPage() {
  return (
    <div className="min-h-screen bg-[#faf9f6]">
      {/* Hero section */}
      <div className="bg-gradient-to-b from-[#1a1a1a] to-[#2d2d2d] text-white py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          >
            Complétez le formulaire ci-dessous pour réserver votre séjour d&apos;exception
          </p>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
          <iframe
            src="https://wkf.ms/3Zy1HJe"
            width="100%"
            height="800"
            style={{ border: 'none', minHeight: '800px' }}
            title="Formulaire d'inscription Pessah 2026"
