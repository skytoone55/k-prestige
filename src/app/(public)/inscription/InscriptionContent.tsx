  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-[#faf9f6]">
        ...
        <div
          className="min-h-[80vh] flex items-center justify-center p-4 pt-24 relative"
          style={{
        ...
        >
          ...
          {/* Card principale */}
          <div className="bg-white rounded-xl shadow-2xl p-8 md:p-10 max-w-xl w-full relative z-10">
            {/* Logo */}
            <div className="mb-8">
              <Image
            ...
            <div className="mt-8">
              <a
                ...
                className="inline-block px-8 py-3 bg-[var(--gold)] text-white rounded-md hover:bg-[var(--gold-dark)] transition-colors font-medium"
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="max-w-3xl mx-auto space-y-8">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8">
              <h2
                className="text-2xl mb-6 text-[var(--gold)] text-center"
                style={{ fontFamily: 'var(--font-cormorant)' }}
              >
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 text-center">
              <h2
                className="text-2xl mb-4 text-[var(--gold)]"
                style={{ fontFamily: 'var(--font-cormorant)' }}
              >
                Besoin d&apos;aide ?
              </h2>
